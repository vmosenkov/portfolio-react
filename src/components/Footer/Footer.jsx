      ...
      <div className="container">
         <div className="footer__wrapper">
            <ul className="social">
               ...
               <li className="social__item"><a href="www.linkedin.com/in/vmosenkov" rel="noreferrer" target="_blank"><BsLinkedin className="social__icons" /></a></li>
            ...
            <div className="copyright">
               {/* <p>All content copyright Vladislav Mosenkov</p> */}
            </div>
